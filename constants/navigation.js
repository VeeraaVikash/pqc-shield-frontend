import { Activity, Server, ShieldCheck, Globe, Terminal, KeyRound, BarChart3, FileText, Zap, Settings } from 'lucide-react';
...
export const NAV_ITEMS = [
  ...
  { id: 'tls',        path: '/tls',         label: 'TLS Integration',  icon: Globe       },
