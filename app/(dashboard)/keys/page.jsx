...
export default function KeysPage() {
  ...
  const handleRotate = async (keyId) => { await api.rotateKey(keyId); refetch(); };
  const cols=[
  ...
  return (<>
    ...
    <div className="mt-2 text-[10px] text-slate-600 text-center">Data from SQLite &middot; Refresh 10s</div>
  </>);
}
